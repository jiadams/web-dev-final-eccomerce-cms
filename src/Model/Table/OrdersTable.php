 ...
 * @property \Cake\ORM\Association\HasMany $OrderedProducts
 *
...
class OrdersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('apt_num', 'create')
            ->notEmpty('apt_num');
        ...
        $validator
            ...
            ->requirePresence('payment_authorized', 'create')
            ->notEmpty('payment_authorized');
